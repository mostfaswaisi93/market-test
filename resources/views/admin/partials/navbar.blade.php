...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex">
                <div class="mr-50"><img src="{{ url('admin_files/app-assets/images/icons/xls.png') }}" alt="png"
                        height="32"></div>
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ url('admin_files/app-assets/images/icons/jpg.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ url('admin_files/app-assets/images/icons/pdf.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="mr-50"><img src="{{ url('admin_files/app-assets/images/icons/doc.png') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img
                        src="{{ url('admin_files/app-assets/images/portrait/small/avatar-s-8.jpg') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img
                        src="{{ url('admin_files/app-assets/images/portrait/small/avatar-s-1.jpg') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img
                        src="{{ url('admin_files/app-assets/images/portrait/small/avatar-s-14.jpg') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a
            ...
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img
                        src="{{ url('admin_files/app-assets/images/portrait/small/avatar-s-6.jpg') }}" alt="png"
                        height="32"></div>
                <div class="search-data">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li class="active"><a href="dashboard-ecommerce.html"><i class="feather icon-circle"></i><span
            ...
            <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a href="../../../starter-kit/rtl/vertical-menu-template-semi-dark/sk-layout-2-columns.html"><i
                                class="feather icon-circle"></i><span class="menu-item" data-i18n="2 columns">2
                                columns</span></a>
                    </li>
                    <li><a href="../../../starter-kit/rtl/vertical-menu-template-semi-dark/sk-layout-fixed-navbar.html"><i
                                class="feather icon-circle"></i><span class="menu-item" data-i18n="Fixed navbar">Fixed
                                navbar</span></a>
                    </li>
                    <li><a
                            href="../../../starter-kit/rtl/vertical-menu-template-semi-dark/sk-layout-floating-navbar.html"><i
                                class="feather icon-circle"></i><span class="menu-item"
                                data-i18n="Floating navbar">Floating navbar</span></a>
                    </li>
                    <li><a href="../../../starter-kit/rtl/vertical-menu-template-semi-dark/sk-layout-fixed.html"><i
