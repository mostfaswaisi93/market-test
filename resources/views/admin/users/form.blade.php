                ...
                <form method="post" id="userForm" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="gender" class="control-label col-md-2">@lang('site.gender'): </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="phone" class="control-label col-md-2">@lang('site.phone'): </label>
                                <div class="col-md-12">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nickname" class="control-label col-md-2">@lang('site.nickname'): </label>
                                <div class="col-md-12">
                                    <input type="text" name="nickname" id="nickname" class="form-control"
                                        placeholder="@lang('site.enter_nickname')" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="age" class="control-label col-md-2">@lang('site.age'): </label>
                                <div class="col-md-12">
                                    <input type="number" name="age" id="age" class="form-control"
                                        placeholder="@lang('site.enter_age')" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="notes" class="control-label col-md-2">@lang('site.notes'): </label>
                        <div class="col-md-12">
                            <textarea class="form-control" name="notes" cols="30" rows="7" id="notes"
                                placeholder="@lang('site.enter_notes')"></textarea>
                        </div>
                    </div>
            </div>
