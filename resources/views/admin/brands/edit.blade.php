...
@section('title') @lang('admin.edit_brand') @endsection
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">@lang('admin.edit_brand')</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">@lang('admin.edit_brand')</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            ...
                            @lang('admin.edit_brand') {{ $brand->name }}
                        </h4>
                    </div>
                            ...
                            <form action="{{ route('admin.categories.update', $brand->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="media mb-2">
                                            <a class="mr-2 my-25" href="#">
                                                <img src="{{ $brand->image_path_ar }}" alt="users avatar"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="media mb-2">
                                            <a class="mr-2 my-25" href="#">
                                                <img src="{{ $brand->image_path_en }}" alt="users avatar"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="media mb-2">
                                            <a class="mr-2 my-25" href="#">
                                                <img src="{{ $brand->icon_path }}" alt="users avatar"
