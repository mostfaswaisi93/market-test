...
<body
    style="direction: {{ config('app.locale') == 'ar' ? 'rtl' : 'ltr' }};font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #f5f8fa; color: #74787e; height: 100%; hyphens: auto; line-height: 1.4; margin: 0; -moz-hyphens: auto; -ms-word-break: break-all; width: 100% !important; -webkit-hyphens: auto; -webkit-text-size-adjust: none; word-break: break-word;">
    <style>
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ route('invoice.index') }}"
                                ...
                                <img src="{{ asset('frontend/images/logo.png') }}" style="max-width: 120px;"
                                    alt="{{ config('app.name') }}">
                            </a>
                        </td>
                    </tr>
